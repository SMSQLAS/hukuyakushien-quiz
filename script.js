...
<br>
  外来服薬支援料2算定可？不可？`,
    "answer": true,
    "explanation": `（2科の処方を合わせて一包化することで、「1剤で3種類以上の内服薬」を一包化するという要件を満たすため、算定可。<br><br>
ただし、どちらの処方医からも一包化の指示をもらう必要あり）<br><br>
「処方」欄の記載内容からは加算理由が不明のときは、算定理由が明確となるように記載すること。<br><br>
