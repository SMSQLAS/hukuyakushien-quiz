...
<br>
  両処方あわせて一包化指示あり。外来服薬支援料2算定可？不可？`,
    ...
    choiceFalse:"算定できない",
    "answer": true,
    "explanation": "（算定可。<strong>それぞれの処方だけでは一包化の条件を満たしていないが２枚をあわせると条件を満たす場合、それぞれのDrの指示を受ければ算定可能。<br>「処方」欄の記載内容からは加算理由が不明なので、コメントコードが必要<br>（2101異なる保険の発行する処方箋に係る算定理由）</strong>）"
  },
